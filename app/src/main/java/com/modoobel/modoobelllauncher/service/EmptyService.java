...
//            notification.setLatestEventInfo(getApplicationContext(), "", "", null);
    ...
    private void registerRestartAlarm(){
        ...
        Intent intent = new Intent(EmptyService.this,RestartService.class);
        intent.setAction("ACTION.RESTART.EmptyService");
        PendingIntent sender = PendingIntent.getBroadcast(EmptyService.this,0,intent,0);
